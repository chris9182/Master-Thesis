...
\section{Clustering}
The clustering algorithms implemented were used to create base clusterings for meta-clustering. The algorithms described in this section are the ones used, except for OPTICS which was used for meta-clustering. For additional information on why OPTICS was used on a meta level, see Section [REFFERENCE].
\subsection{OPTICS}
