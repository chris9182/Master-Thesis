...
Visual clustering frameworks and tools aim to help users to perform clustering in a simpler way and to visualize results, such that they can make more educated decisions on which algorithms to use and to analyze the quality of their result. 
...
\subsection{Consensus Clustering Frameworks}
